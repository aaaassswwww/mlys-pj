...
最终转 PDF 前，我建议在附录里补上以下材料截图或表格：

- 一段 Phase 1 profiling / synthetic probe 输出
- 一段 Phase 2 候选表和 correctness failure 报告
- 一段 Phase 3 throughput benchmark breakdown
- 一段 prompt debug / runtime feedback 示例
